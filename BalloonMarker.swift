...
open class BalloonMarker: MarkerImage
{
  ...
  public init(title: String? = nil, color: UIColor, font: UIFont, textColor: UIColor, insets: UIEdgeInsets)
  {
    super.init()
  ...
  open override func refreshContent(entry: ChartDataEntry, highlight: Highlight)
  {
    ...
    if let pieEntry = entry as? PieChartDataEntry {
      ...
      setLabel("\(pieEntry.label!)\n\(Int(pieEntry.y)) crimes")
    }
  ...
  open func setLabel(_ label: String)
  {
    ...
    size.height = (1.5 * _labelSize.height) + self.insets.top + self.insets.bottom
